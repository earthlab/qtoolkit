...
vignette: >
  %\VignetteIndexEntry{QToolkit 101: Get Survey Data}
...
1. make sure strip_html works on choices too
2. apply factors as an option ?? or atleast order the choices by order... 
