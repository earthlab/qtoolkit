...
s_list <- get_survey()              # get all surveys
s_list <- get_survey(name="week")   # get all surveys who's name matches "week"
s_list <- get_survey(id="SV_")      # get all surveys who's id matches "SV_"
